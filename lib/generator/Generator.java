...
public class Generator {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("generator/Big5_GFC_Tpl.java"));
        ...
        while ((line = reader.readLine()) != null) {
            ...
            else if(line.contains("Big5_GFC_Tpl")){
            	writer.write(line.replaceAll("Big5_GFC_Tpl", "Big5_GFC")); 
            }
            else{
                writer.write(line); 
            }
